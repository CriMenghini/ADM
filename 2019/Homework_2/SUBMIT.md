...
## When?
Homework 2 is due on __27th October 2019 - 23:59:59__. Any homework submitted after the deadline will be subjected to a penalisation with the following schema:
...
* `main.ipynb`: a Jupyter notebook that contains all the answers to your exercises. The notebook must be clear, complete and tidy. [Here](https://github.com/dusicastepic/ADMSecondHomework/blob/master/ADM_HW2_Full.ipynb) an example of a nice notebook from last year.
